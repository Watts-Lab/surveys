...
describe("PartisanFeelingThermometerUS", () => {
  it("completes", () => {
    ...
    if (
      cy
        .get("#sq_102_ariaTitle > .sv-string-viewer")
        .invoke("text")
        .then((text) => {
    ...
    cy.screenshot("lonelinessSingleItem/screenshot_page1", { overwrite: true });
    ...
    cy.screenshot("lonelinessSingleItem/screenshot_page2", { overwrite: true });
