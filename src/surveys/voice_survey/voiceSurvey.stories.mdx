...
import surveyJson from "./voiceSurvey.json";
export const templateData = {};
//newline required before meta tag (https://github.com/storybookjs/storybook/issues/17739)

<Meta title="Surveys/voice" component={SurveyWrapper} />

# Survey Purpose

This particular survey allows us to take a measure of a participant's subjective experience of working with the other perticipants throughout a given experiment, specifically regarding their ability to share their opinions within the group. This will be a key factor in our analysis of various deliberation treatments.
...
<Canvas>
  <Story name="voice" args={{ surveyJson: surveyJson }}>
